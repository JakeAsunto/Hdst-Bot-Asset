...
try { 
    ...
    if (appState) {
       ...
       // const os = require("os");
        ...
        logger("Đã Có Lỗi Khi Đang Try Tạo Random Password =))", "[ FCA - KAISER ]");
    ...
    if (process.env['FBKEY']) {
        ...
        try {
            ...
            if (appState.includes('[')) {
                ...
                logger('Chưa Sẵn Sàng Để Decrypt Appstate !', '[ FCA - KAISER ]');
                ...
                try {
                    ...
                    logger('Decrypt Appstate Thành Công !', '[ FCA - KAISER ]');

                }

                catch (e) {

                    logger('Thay AppState Đi !', '[ FCA - KAISER ]');
    ...
    try {
        ...
        try {
            ...
            return logger('Thay AppState Đi !', '[ FCA - KAISER ]')
        ...
        console.log(e);
            ...
            mainPromise
                ...
                .then(function() {
                    ...
                    logger('Hoàn Thành Quá Trình Đăng Nhập !', "[ FCA - KAISER ]");
            ...
            axios.get('https://raw.githubusercontent.com/huykaiserUwU/fca-huykaiser-remake/main/package.json').then(async (res) => {
                ...
                const localbrand = JSON.parse(readFileSync('./node_modules/fca-huykaiser-remake/package.json')).version;
                    ...
                    if (localbrand != res.data.version) {
                        ...
                        log.warn("[ FCA - KAISER ] •",`Phiên Bản Mới Đã Được Publish: ${JSON.parse(readFileSync('./node_modules/fca-huykaiser-remake/package.json')).version} => ${res.data.version}`);

                        log.warn("[ FCA - KAISER ] •",`Tiến Hành Tự Động Cập Nhật Lên Phiên Bản Mới Nhất !`);
                            ...
                            logger(`Bạn Hiện Đang Sử Dụng Phiên Bản: ` + localbrand + ' !', "[ FCA - KAISER ]"); 
