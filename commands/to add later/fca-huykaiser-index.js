...
function buildAPI(globalOptions, html, jar) {
    ...
    logger(`Đăng Nhập Tại ID: ${userID}`, "[ FCA - KAISER ]");
    ...
    if (oldFBMQTTMatch) {
        ...
        logger(`Vùng Của Tài Khoản Là: ${region}`, "[ FCA - KAISER ]");
...
function makeLogin(jar, email, password, loginOptions, callback, prCallback) {
    ...
    return function(res) {
        ...
        logger("Đang Đăng Nhập...", "[ FCA - KAISER ]");
        ...
        return utils
            ...
            .then(function(res) {
                ...
                if (headers.location.indexOf('https://www.facebook.com/checkpoint/') > -1) {
                    ...
                    logger("Bạn Đang Bật 2 Bảo Mật !", "[ FCA - KAISER ]");
                                            ...
                                            utils
                                                ...
                                                .then(res => {
                                                    ...
                                                    try {
                                                        ...
                                                        logger("Xác Nhận Từ Trình Duyệt, Đang Đăng Nhập...", "[ FCA - KAISER ]");
...
try { 
    ...
    if (appState) {
       ...
       // const os = require("os");
        ...
        // prompt: chalk.hex('#00CCCC').bold('[FCA - KAISER] • ')
        ...
        //                             logger("Tạo File ENV Thất Bại !", "[ FCA - KAISER ]")

        //                             rl.pause();

        //                         }

        //                         else logger("Tạo Thành Công File ENV !","[ FCA - KAISER ]")
        ...
        //                 logger("Đã Có Lỗi Khi Đang Try Tạo Ra Câu Hỏi =))", "[ FCA - KAISER ]");
                ...
                var ans = makeid(49)
                    ...
                    process.env["FBKEY"] = ans;
                        ...
                        fs.writeFile('./../.env', `FBKEY=${ans}`, function (err) {
                            ...
                            logger("Create env file failed", "[ FCA - KAISER ]");

                    }

                else logger("Create env file success","[ FCA - KAISER ]")
        ...
        logger("There was an error while trying to generate random password", "[ FCA - KAISER ]");
    ...
    if (process.env['FBKEY']) {
        ...
        try {
            ...
            if (appState.includes('[')) {
                ...
                logger('Not ready to decrypt appstate', '[ FCA - KAISER ]');
                ...
                try {
                    ...
                    logger('Decrypt Appstate Success!', '[ FCA - KAISER ]');

                }

                catch (e) {

                    logger('Appstate Go!', '[ FCA - KAISER ]')
    ...
    try {
        ...
        try {
            ...
            return logger('Appstate Go!', '[ FCA - KAISER ]')
        ...
        console.log(e);
            ...
            mainPromise
                ...
                .then(function() {
                    ...
                    logger('Complete the login process', "[ FCA - KAISER ]");

                        logger('Auto Check Update ...', "[ FCA - KAISER ]");
            ...
            axios.get('https://raw.githubusercontent.com/huykaiserUwU/fca-huykaiser-remake/main/package.json').then(async (res) => {

                const localbrand = JSON.parse(readFileSync('./node_modules/fca-huykaiser-remake/package.json')).version;
					// REMOVED AUTO UPDATER
					const state = true;
					
                    if (state == false) {//(localbrand != res.data.version) {

                        log.warn("[ FCA - KAISER ] •",`New Version Published: ${JSON.parse(readFileSync('./node_modules/fca-huykaiser-remake/package.json')).version} => ${res.data.version}`);

                        log.warn("[ FCA - KAISER ] •",`Perform Automatic Update to the Latest Version!`);

                            try {

                                execSync('npm install fca-huykaiser-remake@latest', { stdio: 'inherit' });

                                logger("Nâng Cấp Phiên Bản Thành Công!","[ FCA - KAISER ]")

                                logger('Đang Khởi Động Lại...', '[ FCA - KAISER ]');
                            ...
                            log.warn('Lỗi Auto Update ! ' + err);
                                ...
                                try {
                                    ...
                                    if (data) {
                                        ...
                                        logger.onLogger('Đã Gửi Báo Cáo Lỗi Tới Server !', '[ FCA - KAISER ]'," #FF0000")
                                    ...
                                    logger.onLogger('Đã Xảy Ra Lỗi Khi Cố Gửi Lỗi Đến Server', '[ FCA - KAISER ]'," #FF0000")
                            ...
                            logger(`You are currently using version: ` + localbrand + ' !', "[ FCA - KAISER ]"); 
