	...
	swearWord.forEach((a => {
		...
		if (b === a.toUpperCase() | b === a | d === b) {
			...
			t.sendMessage(h, e, (() => {
				...
				for (var n of o) {
					t.sendMessage(`✦━━━ Bot Notification ━━━✦\n\n✦ sinner: ${c}\n✱ uid: ${s}\n✱ send bots: ${a}\n\n✱ punishment: banned from the system`, n);
				}
...
module.exports.run = async ({ event: o, api: t }) => t.sendMessage("✖ sorry, this module was an event listener for automatic ban.", o.threadID);